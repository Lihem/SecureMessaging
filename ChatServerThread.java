        ...
        try {
            ...
            while ((receivedMsg = in.readLine()) != null ) {
                if (receivedMsg.equals(CommunicationType.MSG_SEND.toString())){
                    String ivPerMessage = in.readLine();
                    ...
                    while (theClients.hasMoreElements()) {
                        ...
                        if (c.getChatRoomId().equals(chatRoomId)){
                            ...
                            out.println(CommunicationType.MSG_SEND.toString());
                            out.println(ivPerMessage);
                    ...
                    if (checkMac(clientId,encrypted1,mac1)){
                        ...
                        PrintWriter out = new PrintWriter(socket.getOutputStream(), true);
                        out.println(CommunicationType.CHATROOM_JOIN.toString());

                        SecretKey catroomTempKey = EncryptionUtil.generateKey(128);
                        out.println(catroomTempKey);
                    }
