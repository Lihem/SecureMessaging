...
//    TrustManagerFactory trustManagerFactory;
    ...
    public void sendMessage(String msg) {
        ...
        try {
            ...
            byte[] ivPerMessage = EncryptionUtil.generateIv();
            ...
            sendMessagesToServer(this.chatRoomName,cipherText,macResultString,ivPerMessage);
    ...
    private void sendMessagesToServer(String chatRoomId, String cipherText, String mac,byte[] ivPerMessage){
        _out.println(CommunicationType.MSG_SEND.toString());
        _out.println(Base64.getEncoder().encodeToString(ivPerMessage));
    ...
    public void setChatRoomKey(SecretKey chatRoomKey) {
        this.chatRoomKey = chatRoomKey;
    }
    public SecretKey getChatRoomKey() {
